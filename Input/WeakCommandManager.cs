...
/// <summary>
/// A manager for <see cref="WeakCommand"/>.
/// </summary>
public static class WeakCommandManager
{
    private static void CallHandler(object sender, EventHandler eventHandler)
    {
        if (eventHandler != null)
        {
            if (SynchronizationContext.Current != null)
                SynchronizationContext.Current.Post((o) => eventHandler(sender, EventArgs.Empty), null);
