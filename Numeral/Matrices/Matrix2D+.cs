...
/// <inheritdoc cref="IMatrix2D{T}"/>
[CollectionBuilder(typeof(MatrixBuilder), nameof(MatrixBuilder.Create))]
[Description(IMatrix.Description)]
[Using(typeof(IMatrix))]
public readonly record struct Matrix<T>
    : IMatrix<Matrix<T>, T>, IMatrix2D<T>, IMatrixImmutable<T>, IMatrixUnfixed<T>
{
...
#pragma warning restore CA1819
    ...
    Array IArray<Matrix<T>, T>.GetArray() => new T[Rows][];

    static Matrix<T> IArray<Matrix<T>, T>.Create(Matrix<T> oldSelf, Array newSelf) => new((T[][])newSelf);
